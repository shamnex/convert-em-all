...
"use strict";
eval("\n\nvar _country = __webpack_require__(/*! ./models/country */ \"./src/scripts/models/country.js\");\n\nvar _country2 = _interopRequireDefault(_country);\n\nvar _currency = __webpack_require__(/*! ./models/currency */ \"./src/scripts/models/currency.js\");\n\nvar _currency2 = _interopRequireDefault(_currency);\n\nvar _convert = __webpack_require__(/*! ./models/convert */ \"./src/scripts/models/convert.js\");\n\nvar _convert2 = _interopRequireDefault(_convert);\n\nvar _idb = __webpack_require__(/*! ./models/idb */ \"./src/scripts/models/idb.js\");\n\nvar _idb2 = _interopRequireDefault(_idb);\n\nvar _serviceWorker = __webpack_require__(/*! ./models/service-worker */ \"./src/scripts/models/service-worker.js\");\n\nvar _serviceWorker2 = _interopRequireDefault(_serviceWorker);\n\nvar _currencyView = __webpack_require__(/*! ./views/currencyView */ \"./src/scripts/views/currencyView.js\");\n\nvar currencyView = _interopRequireWildcard(_currencyView);\n\nvar _convertView = __webpack_require__(/*! ./views/convertView */ \"./src/scripts/views/convertView.js\");\n\nvar convertView = _interopRequireWildcard(_convertView);\n\nvar _toastView = __webpack_require__(/*! ./views/toastView */ \"./src/scripts/views/toastView.js\");\n\nvar toastView = _interopRequireWildcard(_toastView);\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/scripts/views/base.js\");\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; } // import './../sass/main.scss';\n\n\n//===================================\n// APP STATE\n//===================================\nvar state = {};\n//===================================\n// CONTROLLERS\n//===================================\n\nvar idbController = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n        return regeneratorRuntime.wrap(function _callee$(_context) {\n            while (1) {\n                switch (_context.prev = _context.next) {\n                    case 0:\n                        state.idb = new _idb2.default();\n\n                    case 1:\n                    case \"end\":\n                        return _context.stop();\n                }\n            }\n        }, _callee, undefined);\n    }));\n\n    return function idbController() {\n        return _ref.apply(this, arguments);\n    };\n}();\n\nvar swController = function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {\n        return regeneratorRuntime.wrap(function _callee2$(_context2) {\n            while (1) {\n                switch (_context2.prev = _context2.next) {\n                    case 0:\n\n                        state.serviceWorker = new _serviceWorker2.default();\n                        _context2.next = 3;\n                        return state.serviceWorker.registerSW();\n\n                    case 3:\n                    case \"end\":\n                        return _context2.stop();\n                }\n            }\n        }, _callee2, undefined);\n    }));\n\n    return function swController() {\n        return _ref2.apply(this, arguments);\n    };\n}();\n\nvar convertController = function () {\n    var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {\n        var fromCurrency, toCurrency, amount, item, key, val;\n        return regeneratorRuntime.wrap(function _callee3$(_context3) {\n            while (1) {\n                switch (_context3.prev = _context3.next) {\n                    case 0:\n                        _context3.next = 2;\n                        return convertView.getFromCurrencyValue();\n\n                    case 2:\n                        fromCurrency = _context3.sent;\n                        _context3.next = 5;\n                        return convertView.getToCurrencyValue();\n\n                    case 5:\n                        toCurrency = _context3.sent;\n                        _context3.next = 8;\n                        return convertView.getAmountValue();\n\n                    case 8:\n                        amount = _context3.sent;\n\n\n                        //get hold of the converter\n                        state.converter = new _convert2.default(amount, fromCurrency, toCurrency);\n\n                        // validate input\n\n                        if (!(!toCurrency || !fromCurrency)) {\n                            _context3.next = 12;\n                            break;\n                        }\n\n                        return _context3.abrupt(\"return\");\n\n                    case 12:\n\n                        //show loading\n                        convertView.showSpinner();\n\n                        //Fetch rate from cache\n                        _context3.next = 15;\n                        return state.idb.getItem(state.converter.query);\n\n                    case 15:\n                        item = _context3.sent;\n\n                        if (!item) {\n                            _context3.next = 20;\n                            break;\n                        }\n\n                        //if item is in cache\n                        state.converter.convertOffline(item.val);\n                        _context3.next = 23;\n                        break;\n\n                    case 20:\n                        _context3.next = 22;\n                        return state.converter.convertOnline();\n\n                    case 22:\n                        //5) Save To DB\n                        if (state.converter.rates) {\n                            key = state.converter.query;\n                            val = state.converter.rates;\n\n                            state.idb.setItem(key, val);\n                        }\n\n                    case 23:\n                        if (!state.converter.error) {\n                            _context3.next = 25;\n                            break;\n                        }\n\n                        return _context3.abrupt(\"return\", convertView.showError(state.converter.error));\n\n                    case 25:\n                        if (!(!state.converter.result || !amount)) {\n                            _context3.next = 27;\n                            break;\n                        }\n\n                        return _context3.abrupt(\"return\", convertView.clearResults());\n\n                    case 27:\n\n                        // Display Result\n                        convertView.displayResults(state.converter.result);\n\n                    case 28:\n                    case \"end\":\n                        return _context3.stop();\n                }\n            }\n        }, _callee3, undefined);\n    }));\n\n    return function convertController() {\n        return _ref3.apply(this, arguments);\n    };\n}();\n\nvar currencyController = function () {\n    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4() {\n        var db, res;\n        return regeneratorRuntime.wrap(function _callee4$(_context4) {\n            while (1) {\n                switch (_context4.prev = _context4.next) {\n                    case 0:\n                        //fetch currencies from CACHE\n                        state.currencies = new _currency2.default();\n\n                        if (state.idb._db) {\n                            _context4.next = 17;\n                            break;\n                        }\n\n                        _context4.next = 4;\n                        return state.idb.dbPromise;\n\n                    case 4:\n                        db = _context4.sent;\n                        _context4.next = 7;\n                        return state.idb.getItem(\"currencies\", db);\n\n                    case 7:\n                        res = _context4.sent;\n\n                        if (!res) {\n                            _context4.next = 12;\n                            break;\n                        }\n\n                        state.currencies.setCurrencies(res.val);\n                        _context4.next = 17;\n                        break;\n\n                    case 12:\n                        _context4.t0 = state.idb;\n                        _context4.next = 15;\n                        return state.currencies.getCurrencies();\n\n                    case 15:\n                        _context4.t1 = _context4.sent;\n\n                        _context4.t0.setItem.call(_context4.t0, \"currencies\", _context4.t1);\n\n                    case 17:\n\n                        currencyView.displayCurrencies(state.currencies.currencies);\n\n                    case 18:\n                    case \"end\":\n                        return _context4.stop();\n                }\n            }\n        }, _callee4, undefined);\n    }));\n\n    return function currencyController() {\n        return _ref4.apply(this, arguments);\n    };\n}();\n\n//===================================\n// HELPER FUNCTIONS\n//===================================\n\nvar handleInputChange = function handleInputChange() {\n    convertController();\n};\n\n//debounce stolen from _underscore.js to delay immediate execution of keypress events\nvar debounce = function debounce(func, wait, immediate) {\n    var timeout;\n    return function () {\n        var context = this,\n            args = arguments;\n        var later = function later() {\n            timeout = null;\n            if (!immediate) func.apply(context, args);\n        };\n        var callNow = immediate && !timeout;\n        clearTimeout(timeout);\n        timeout = setTimeout(later, wait);\n        if (callNow) func.apply(context, args);\n    };\n};\n\n//===================================\n// EVENT LISTENERS\n//===================================\ndocument.addEventListener(\"DOMContentLoaded\", function () {\n    // countryController();\n    idbController();\n    currencyController();\n    swController();\n});\n\n_base.elements.amountInput.addEventListener(\"input\", debounce(handleInputChange, 1000));\n_base.elements.fromCurrency.addEventListener(\"change\", handleInputChange);\n_base.elements.toCurrency.addEventListener(\"change\", handleInputChange);\n\n//# sourceURL=webpack:///./src/scripts/app.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/scripts/constants.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Conversion = function () {\n    function Conversion(amount, fromCurrency, toCurrency) {\n        _classCallCheck(this, Conversion);\n\n        this._amount = amount;\n        this._fromCurrency = fromCurrency;\n        this._toCurrency = toCurrency;\n        this.query = fromCurrency + \"_\" + toCurrency;\n        this.queryInverse = toCurrency + \"_\" + fromCurrency;\n        this.url = \"\" + _constants.constants.BASE_URL + _constants.constants.CONVERT_URL + this.query + \",\" + this.queryInverse + \"&compact=ultra\";\n    }\n\n    _createClass(Conversion, [{\n        key: \"convertOnline\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var value;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                console.log(\"converting online\");\n                                _context.prev = 1;\n\n                                if (!(!this._fromCurrency || !this._toCurrency)) {\n                                    _context.next = 4;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\");\n\n                            case 4:\n                                _context.next = 6;\n                                return fetch(this.url);\n\n                            case 6:\n                                _context.next = 8;\n                                return _context.sent.json();\n\n                            case 8:\n                                this.rates = _context.sent;\n                                value = +this.rates[this.query];\n\n                                this._convert(value);\n\n                                _context.next = 16;\n                                break;\n\n                            case 13:\n                                _context.prev = 13;\n                                _context.t0 = _context[\"catch\"](1);\n\n                                this.error = _context.t0;\n\n                            case 16:\n                                ;\n\n                            case 17:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[1, 13]]);\n            }));\n\n            function convertOnline() {\n                return _ref.apply(this, arguments);\n            }\n\n            return convertOnline;\n        }()\n    }, {\n        key: \"convertOffline\",\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(rates) {\n                var value;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                console.log(\"converting offline\");\n                                _context2.prev = 1;\n\n                                if (!(!this._fromCurrency || !this._toCurrency)) {\n                                    _context2.next = 4;\n                                    break;\n                                }\n\n                                return _context2.abrupt(\"return\");\n\n                            case 4:\n                                value = +rates[this.query];\n\n                                this._convert(value);\n                                _context2.next = 11;\n                                break;\n\n                            case 8:\n                                _context2.prev = 8;\n                                _context2.t0 = _context2[\"catch\"](1);\n\n                                console.log(_context2.t0);\n\n                            case 11:\n                            case \"end\":\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[1, 8]]);\n            }));\n\n            function convertOffline(_x) {\n                return _ref2.apply(this, arguments);\n            }\n\n            return convertOffline;\n        }()\n    }, {\n        key: \"_convert\",\n        value: function () {\n            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(value) {\n                var total, error;\n                return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                    while (1) {\n                        switch (_context3.prev = _context3.next) {\n                            case 0:\n                                if (!value) {\n                                    _context3.next = 5;\n                                    break;\n                                }\n\n                                total = value * this._amount;\n                                return _context3.abrupt(\"return\", this.result = Math.round(total * 100) / 100);\n\n                            case 5:\n                                error = new Error(\"value not found for \" + query);\n\n                                this.error = error;\n                                throw error;\n\n                            case 8:\n                            case \"end\":\n                                return _context3.stop();\n                        }\n                    }\n                }, _callee3, this);\n            }));\n\n            function _convert(_x2) {\n                return _ref3.apply(this, arguments);\n            }\n\n            return _convert;\n        }()\n    }]);\n\n    return Conversion;\n}();\n\nexports.default = Conversion;\n\n//# sourceURL=webpack:///./src/scripts/models/convert.js?");

/***/ }),

/***/ "./src/scripts/models/country.js":
/*!***************************************!*\
  !*** ./src/scripts/models/country.js ***!
  \***************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/scripts/constants.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar Countries = function () {\n    function Countries() {\n        _classCallCheck(this, Countries);\n    }\n\n    _createClass(Countries, [{\n        key: \"getCountries\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var url, _ref2, countries;\n\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                _context.prev = 0;\n                                url = \"\" + _constants.constants.BASE_URL + _constants.constants.COUNTRY_URL;\n                                _context.next = 4;\n                                return fetch(url);\n\n                            case 4:\n                                _context.next = 6;\n                                return _context.sent.json();\n\n                            case 6:\n                                _ref2 = _context.sent;\n                                countries = _ref2.results;\n\n                                this.countries = Object.values(countries);\n\n                                _context.next = 14;\n                                break;\n\n                            case 11:\n                                _context.prev = 11;\n                                _context.t0 = _context[\"catch\"](0);\n\n                                console.log(_context.t0);\n\n                            case 14:\n                                ;\n\n                            case 15:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[0, 11]]);\n            }));\n\n            function getCountries() {\n                return _ref.apply(this, arguments);\n            }\n\n            return getCountries;\n        }()\n    }]);\n\n    return Countries;\n}();\n\nexports.default = Countries;\n\n//# sourceURL=webpack:///./src/scripts/models/country.js?");

/***/ }),

/***/ "./src/scripts/models/currency.js":
/*!****************************************!*\
  !*** ./src/scripts/models/currency.js ***!
  \****************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _idb = __webpack_require__(/*! idb */ \"./node_modules/idb/lib/idb.js\");\n\nvar _idb2 = _interopRequireDefault(_idb);\n\nvar _constants = __webpack_require__(/*! ../constants */ \"./src/scripts/constants.js\");\n\nfunction _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar IDB = function () {\n    function IDB() {\n        _classCallCheck(this, IDB);\n\n        this.storeName = _constants.constants.CURRENCY_RATES_STORE;\n        this.open();\n    }\n\n    _createClass(IDB, [{\n        key: \"open\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var _this = this;\n\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                if (window.indexedDB) {\n                                    _context.next = 2;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\");\n\n                            case 2:\n                                _context.prev = 2;\n\n                                this.dbPromise = _idb2.default.open(\"konvatam-db\", 1, function (upgradeDb) {\n                                    upgradeDb.createObjectStore(_this.storeName, {\n                                        keyPath: \"id\"\n                                    });\n                                });\n\n                                _context.next = 6;\n                                return this.dbPromise;\n\n                            case 6:\n                                this._db = _context.sent;\n                                _context.next = 12;\n                                break;\n\n                            case 9:\n                                _context.prev = 9;\n                                _context.t0 = _context[\"catch\"](2);\n\n                                console.log(_context.t0);\n\n                            case 12:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[2, 9]]);\n            }));\n\n            function open() {\n                return _ref.apply(this, arguments);\n            }\n\n            return open;\n        }()\n    }, {\n        key: \"setItem\",\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(key, val) {\n                var transaction, store, result;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n                                _context2.next = 3;\n                                return this._db.transaction(this.storeName, \"readwrite\");\n\n                            case 3:\n                                transaction = _context2.sent;\n                                store = transaction.objectStore(this.storeName);\n                                _context2.next = 7;\n                                return store.put({ id: key, val: val });\n\n                            case 7:\n                                result = _context2.sent;\n                                _context2.next = 13;\n                                break;\n\n                            case 10:\n                                _context2.prev = 10;\n                                _context2.t0 = _context2[\"catch\"](0);\n\n                                console.log(\"error saving item to DB: \" + _context2.t0 + \" \");\n\n                            case 13:\n                            case \"end\":\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 10]]);\n            }));\n\n            function setItem(_x, _x2) {\n                return _ref2.apply(this, arguments);\n            }\n\n            return setItem;\n        }()\n    }, {\n        key: \"getItem\",\n        value: function () {\n            var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(key, db) {\n                var transaction, store, item;\n                return regeneratorRuntime.wrap(function _callee3$(_context3) {\n                    while (1) {\n                        switch (_context3.prev = _context3.next) {\n                            case 0:\n                                _context3.prev = 0;\n                                _context3.next = 3;\n                                return (this._db || db).transaction(this.storeName);\n\n                            case 3:\n                                transaction = _context3.sent;\n                                store = transaction.objectStore(this.storeName);\n                                _context3.next = 7;\n                                return store.get(key);\n\n                            case 7:\n                                item = _context3.sent;\n                                return _context3.abrupt(\"return\", item);\n\n                            case 11:\n                                _context3.prev = 11;\n                                _context3.t0 = _context3[\"catch\"](0);\n\n                                console.log(\"error getting item to DB: \" + _context3.t0 + \" \");\n\n                            case 14:\n                            case \"end\":\n                                return _context3.stop();\n                        }\n                    }\n                }, _callee3, this, [[0, 11]]);\n            }));\n\n            function getItem(_x3, _x4) {\n                return _ref3.apply(this, arguments);\n            }\n\n            return getItem;\n        }()\n    }]);\n\n    return IDB;\n}();\n\nexports.default = IDB;\n\n//# sourceURL=webpack:///./src/scripts/models/idb.js?");

/***/ }),

/***/ "./src/scripts/models/service-worker.js":
/*!**********************************************!*\
  !*** ./src/scripts/models/service-worker.js ***!
  \**********************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\n\nvar _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();\n\nvar _toastView = __webpack_require__(/*! ../views/toastView */ \"./src/scripts/views/toastView.js\");\n\nvar toastView = _interopRequireWildcard(_toastView);\n\nfunction _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nvar ServiceWorker = function () {\n    function ServiceWorker() {\n        _classCallCheck(this, ServiceWorker);\n    }\n\n    _createClass(ServiceWorker, [{\n        key: \"registerSW\",\n        value: function () {\n            var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n                var _this = this;\n\n                var refreshing;\n                return regeneratorRuntime.wrap(function _callee$(_context) {\n                    while (1) {\n                        switch (_context.prev = _context.next) {\n                            case 0:\n                                if (navigator.serviceWorker) {\n                                    _context.next = 2;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\");\n\n                            case 2:\n                                _context.prev = 2;\n                                _context.next = 5;\n                                return navigator.serviceWorker.register(window.location.href + \"sw.js\", { scope: \"/konvatam/\" });\n\n                            case 5:\n                                this.registration = _context.sent;\n\n                                if (this.registration) console.log(\"Service Worker Registered\");\n\n                                if (navigator.serviceWorker.controller) {\n                                    _context.next = 9;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\");\n\n                            case 9:\n                                if (!this.registration.waiting) {\n                                    _context.next = 11;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\", this._updateReady(this.registration.waiting));\n\n                            case 11:\n                                if (!this.registration.installing) {\n                                    _context.next = 13;\n                                    break;\n                                }\n\n                                return _context.abrupt(\"return\", this._trackInstalling(this.registration.installing));\n\n                            case 13:\n\n                                this.registration.addEventListener('updatefound', function () {\n                                    _this._trackInstalling(_this.registration.installing);\n                                });\n\n                                _context.next = 19;\n                                break;\n\n                            case 16:\n                                _context.prev = 16;\n                                _context.t0 = _context[\"catch\"](2);\n\n                                console.log(_context.t0);\n\n                            case 19:\n                                _context.prev = 19;\n                                refreshing = void 0;\n\n                                navigator.serviceWorker.addEventListener('controllerchange', function () {\n                                    if (refreshing) return;\n                                    window.location.reload();\n                                    refreshing = true;\n                                });\n                                return _context.finish(19);\n\n                            case 23:\n                            case \"end\":\n                                return _context.stop();\n                        }\n                    }\n                }, _callee, this, [[2, 16, 19, 23]]);\n            }));\n\n            function registerSW() {\n                return _ref.apply(this, arguments);\n            }\n\n            return registerSW;\n        }()\n    }, {\n        key: \"_trackInstalling\",\n        value: function _trackInstalling(sw) {\n            var _this2 = this;\n\n            sw.addEventListener('statechange', function () {\n                if (sw.state == 'installed') _this2._updateReady(sw);\n            });\n        }\n    }, {\n        key: \"_updateReady\",\n        value: function () {\n            var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(sw) {\n                var toastAnswser;\n                return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                        switch (_context2.prev = _context2.next) {\n                            case 0:\n                                _context2.prev = 0;\n                                _context2.next = 3;\n                                return toastView.showToast(\"New version available\", \"Update\");\n\n                            case 3:\n                                toastAnswser = _context2.sent;\n\n                                console.log(toastAnswser);\n\n                                if (toastAnswser) {\n                                    _context2.next = 7;\n                                    break;\n                                }\n\n                                return _context2.abrupt(\"return\");\n\n                            case 7:\n                                sw.postMessage({ action: 'skipWaiting' });\n                                _context2.next = 12;\n                                break;\n\n                            case 10:\n                                _context2.prev = 10;\n                                _context2.t0 = _context2[\"catch\"](0);\n\n                            case 12:\n                            case \"end\":\n                                return _context2.stop();\n                        }\n                    }\n                }, _callee2, this, [[0, 10]]);\n            }));\n\n            function _updateReady(_x) {\n                return _ref2.apply(this, arguments);\n            }\n\n            return _updateReady;\n        }()\n    }]);\n\n    return ServiceWorker;\n}();\n\nexports.default = ServiceWorker;\n\n//# sourceURL=webpack:///./src/scripts/models/service-worker.js?");

/***/ }),

/***/ "./src/scripts/views/base.js":
/*!***********************************!*\
  !*** ./src/scripts/views/base.js ***!
  \***********************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.showError = exports.showSpinner = exports.clearResults = exports.displayResults = exports.getToCurrencyValue = exports.getFromCurrencyValue = exports.getAmountValue = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/scripts/views/base.js\");\n\nvar getAmountValue = exports.getAmountValue = function getAmountValue() {\n    return _base.elements.amountInput.value;\n};\nvar getFromCurrencyValue = exports.getFromCurrencyValue = function getFromCurrencyValue() {\n    return _base.elements.fromCurrency.value;\n};\nvar getToCurrencyValue = exports.getToCurrencyValue = function getToCurrencyValue() {\n    return _base.elements.toCurrency.value;\n};\n\nvar displayResults = exports.displayResults = function displayResults(result) {\n    clearResults();\n    _base.elements.resultsWrapper.innerHTML = \"\\n        <div class=\\\"results__from\\\">\\n            \" + getAmountValue() + \"<span class=\\\"results__from--currency\\\">(\" + getFromCurrencyValue() + \")</span> =\\n        </div>\\n        \\n        <h1 class=\\\"heading-primary results__to\\\">\\n            \" + result + \"<span>(\" + getToCurrencyValue() + \")</span>\\n        </h1>\\n    \";\n};\n\nvar clearResults = exports.clearResults = function clearResults() {\n    _base.elements.resultsWrapper.innerHTML = \"\\n    \";\n};\n\nvar showSpinner = exports.showSpinner = function showSpinner() {\n    _base.elements.resultsWrapper.innerHTML = \"\\n        <div class=\\\"loading\\\"></div>\\n    \";\n};\n\nvar showError = exports.showError = function showError(error) {\n    var message = void 0;\n    if (error.message === \"Failed to fetch\") {\n        message = \"Internet required for this conversion\";\n    }\n    _base.elements.resultsWrapper.innerHTML = \"\\n        <div class=\\\"results__error\\\">\\n           <div class=\\\"results__error--message\\\">\" + (message || error.message) + \"</div> \\n        </div>\\n\\n    \";\n};\n\n//<div class=\"btn results__error--btn\">Retry</div>\n\n//# sourceURL=webpack:///./src/scripts/views/convertView.js?");

/***/ }),

/***/ "./src/scripts/views/currencyView.js":
/*!*******************************************!*\
  !*** ./src/scripts/views/currencyView.js ***!
  \*******************************************/
/*! no static exports found */
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n    value: true\n});\nexports.displayCurrencies = undefined;\n\nvar _base = __webpack_require__(/*! ./base */ \"./src/scripts/views/base.js\");\n\nvar displayCurrency = function displayCurrency(currency, element) {\n    var option = document.createElement(\"option\");\n    option.value = \"\" + currency.id;\n    option.innerHTML = \" \" + (currency.currencyName.length > 30 ? currency.currencyName.slice(0, 30) : currency.currencyName) + \" -  (\" + currency.id + \") -\";\n    element.insertAdjacentElement(\"beforeend\", option);\n};\n\nvar displayCurrencies = exports.displayCurrencies = function displayCurrencies(currencies) {\n    if (!currencies) return false;\n    currencies.forEach(function (currency) {\n        displayCurrency(currency, _base.elements.fromCurrency);\n        displayCurrency(currency, _base.elements.toCurrency);\n    });\n};\n\n//# sourceURL=webpack:///./src/scripts/views/currencyView.js?");

/***/ }),

/***/ "./src/scripts/views/toastView.js":
/*!****************************************!*\
  !*** ./src/scripts/views/toastView.js ***!
  \****************************************/
/*! no static exports found */
